...
public class ProductBstIndexSystem {
    public static void main(String[] args) {
        ...
        System.out.println(
                tree.add(new Product(300, "Keyboard", 5)));

        System.out.println(
                tree.add(new Product(100, "Mouse", 8)));

        System.out.println(
                tree.add(new Product(500, "Monitor", 2)));

        System.out.println(
                tree.add(new Product(200, "Hub", 4)));

        System.out.println(
                tree.add(new Product(100, "Duplicate", 1)));
