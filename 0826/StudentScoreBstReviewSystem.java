...
public class StudentScoreBstReviewSystem {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
            "add=" + index.add(
                new StudentRecord(300, "Mina", 78)
            )
        );

        System.out.println(
            "add=" + index.add(
                new StudentRecord(100, "Leo", 84)
            )
        );

        System.out.println(
            "add=" + index.add(
                new StudentRecord(500, "Nora", 91)
            )
        );

        System.out.println(
            "add=" + index.add(
                new StudentRecord(200, "Ivy", 69)
            )
        );

        System.out.println(
            "duplicate=" + index.add(
                new StudentRecord(100, "Other", 50)
            )
        );
        ...
        System.out.println(
            "update=" + index.updateScore(200, 88)
        );

        System.out.println(
            "remove=" + index.remove(300)
        );

        System.out.println(
            "missing=" + index.remove(999)
        );
